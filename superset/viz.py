...
class EchartsCustomScatterViz(BaseViz):

    viz_type = 'echarts_custom_scatter'
    verbose_name = _('Echarts Custom Scatter')
    sort_series = False
    is_timeseries = False

    def query_obj(self):
        d = super(EchartsCustomScatterViz, self).query_obj()
        fd = self.form_data
